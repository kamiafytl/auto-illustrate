...
export const blockColors: Record<PromptBlock, string> = {
  style: 'var(--knx-block-style)',
  sub_style: 'var(--knx-block-sub-style)',
  character: 'var(--knx-block-character)',
  clothing: 'var(--knx-block-clothing)',
  action: 'var(--knx-block-action)',
  expression: 'var(--knx-block-expression)',
  scene: 'var(--knx-block-scene)',
  camera: 'var(--knx-block-camera)',
  effect: 'var(--knx-block-effect)',
}
...
export function blockColor(block?: PromptBlock): string {
  return block ? blockColors[block] : 'var(--knx-muted)'
}
...
export function rebuildViewAtoms(
